...
# !!! Main.UserApp is configured as an alias for Main.AeroSmurf and you might encounter it in some tests
using Main.AeroSmurf, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "AeroSmurf tests" begin
  @includetests ARGS
end
